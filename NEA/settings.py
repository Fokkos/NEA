...
SECRET_KEY = 'k2oy+&-6+@u&a10j@p6#&$jx(qb@&as-8e*#x+x1ixh*vt2c%%'
...
LOGIN_REDIRECT_URL = 'feed' #Defines URL where users are taken once logged in
LOGOUT_REDIRECT_URL = "feed" #Defines URL where users are taken once logged out
